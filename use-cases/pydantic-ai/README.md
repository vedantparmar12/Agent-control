...
If you are not using the Codex CLI, you can simply tell your AI coding assistant to follow the instructions in AGENTS.md.
...
```
pydantic-ai/
├── AGENTS.md                           # Pydantic AI global development rules
